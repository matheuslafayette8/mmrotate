...
default_hooks = dict(
    checkpoint=dict(interval=24, max_keep_ckpts=5, type='CheckpointHook'),
...
train_cfg = dict(max_epochs=120, type='EpochBasedTrainLoop', val_interval=24)
